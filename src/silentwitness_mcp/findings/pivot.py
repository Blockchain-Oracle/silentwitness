...
def _run_pipeline(
    ...
    append_chained_jsonl_line(hypothesis_log, event.model_dump_json())
...
def _write_audit_row(
    ...
    *,
    ...
    can't trip the underlying ``atomic_io.append_jsonl_line`` validator
    that :func:`append_chained_jsonl_line` calls — which would otherwise
    raise inside this function."""
