...
- [ROCBA headline trace findings JSON](https://github.com/Blockchain-Oracle/silentwitness/blob/main/docs/execution_logs/rocba_headline_run/findings.json)
- [ROCBA headline trace findings tool log](https://github.com/Blockchain-Oracle/silentwitness/blob/main/docs/execution_logs/rocba_headline_run/findings.jsonl)
- [ROCBA headline trace index tool log](https://github.com/Blockchain-Oracle/silentwitness/blob/main/docs/execution_logs/rocba_headline_run/index.jsonl)
- [ROCBA headline trace critic log](https://github.com/Blockchain-Oracle/silentwitness/blob/main/docs/execution_logs/rocba_headline_run/critic.jsonl)
- [ROCBA headline trace hypothesis log](https://github.com/Blockchain-Oracle/silentwitness/blob/main/docs/execution_logs/rocba_headline_run/hypothesis.jsonl)
...
[`THREE_CLAIM_TRACE.md`](/docs/three-claim-trace) if the finding IDs or audit IDs
changed.
